...
package com.squidzoo.customButtonBarSkin
{
	 ...
	 */
	public class CustomButtonBarFirstButtonSkin extends ButtonBarButtonSkinBase
	{
		/**
		 *  Constructor.
		 * 
		 ...
		 *  @productversion Flex 4.5
		 */
		public function CustomButtonBarFirstButtonSkin()
		{
			super();
			...
			switch (applicationDPI)
			{
				case DPIClassification.DPI_320: 
				{
					...
					selectedBorderSkin = spark.skins.mobile320.assets.ButtonBarFirstButton_up;
				...
				case DPIClassification.DPI_240:
				{
					...
					selectedBorderSkin = spark.skins.mobile240.assets.ButtonBarFirstButton_up;
				...
				default:
				{
					...
					selectedBorderSkin = spark.skins.mobile160.assets.ButtonBarFirstButton_up;
