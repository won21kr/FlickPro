...
package com.squidzoo.customButtonBarSkin
{
	 ...
	 */
	public class CustomButtonBarLastButtonSkin extends ButtonBarButtonSkinBase
	{
		/**
		 *  Constructor.
		 * 
		 ...
		 *  @productversion Flex 4.5
		 */
		public function CustomButtonBarLastButtonSkin()
		{
			super();
			...
			switch (applicationDPI)
			{
				case DPIClassification.DPI_320: 
				{
					...
					selectedBorderSkin = spark.skins.mobile320.assets.ButtonBarLastButton_up;
				...
				case DPIClassification.DPI_240:
				{
					...
					selectedBorderSkin = spark.skins.mobile240.assets.ButtonBarLastButton_up;
				...
				default:
				{
					...
					selectedBorderSkin = spark.skins.mobile160.assets.ButtonBarLastButton_up;
