...
package com.squidzoo.customButtonBarSkin
{
	import com.squidzoo.customButtonBarSkin.CustomButtonBarFirstButtonSkin;
	import com.squidzoo.customButtonBarSkin.CustomButtonBarMiddleButtonSkin;
	 ...
	 */
	public class CustomButtonBarSkin extends MobileSkin
	{
		//--------------------------------------------------------------------------
		//
		//  Constructor
		 ...
		 *
		 */
		public function CustomButtonBarSkin()
		{
			super();
		}
		...
		override protected function createChildren():void
		{
			...
			if (!firstButton)
			{
				...
				firstButton.skinClass = com.squidzoo.customButtonBarSkin.CustomButtonBarFirstButtonSkin;
			}
			
			if (!lastButton)
			{
				lastButton = new ButtonBarButtonClassFactory(ButtonBarButton);
				lastButton.skinClass = com.squidzoo.customButtonBarSkin.CustomButtonBarLastButtonSkin;
			}
			
			if (!middleButton)
			{
				middleButton = new ButtonBarButtonClassFactory(ButtonBarButton);
				middleButton.skinClass = com.squidzoo.customButtonBarSkin.CustomButtonBarMiddleButtonSkin;
			}
