...
package com.squidzoo.customButtonBarSkin
{
	 ...
	 */
	public class CustomButtonBarMiddleButtonSkin extends ButtonBarButtonSkinBase
	{
		/**
		 *  Constructor.
		 * 
		 ...
		 *  @productversion Flex 4.5
		 */
		public function CustomButtonBarMiddleButtonSkin()
		{
			super();
			...
			switch (applicationDPI)
			{
				case DPIClassification.DPI_320: 
				{
					...
					selectedBorderSkin = spark.skins.mobile320.assets.ButtonBarMiddleButton_up;
				...
				case DPIClassification.DPI_240:
				{
					...
					selectedBorderSkin = spark.skins.mobile240.assets.ButtonBarMiddleButton_up;
				...
				default:
				{
					...
					selectedBorderSkin = spark.skins.mobile160.assets.ButtonBarMiddleButton_up;
