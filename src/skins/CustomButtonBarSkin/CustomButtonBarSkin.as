...
package skins.CustomButtonBarSkin
{
	import skins.CustomButtonBarSkin.CustomButtonBarFirstButtonSkin;
	import skins.CustomButtonBarSkin.CustomButtonBarMiddleButtonSkin;
	...
	public class CustomButtonBarSkin extends MobileSkin
	{
		...
		override protected function createChildren():void
		{
			...
			if (!firstButton)
			{
				...
				firstButton.skinClass = skins.CustomButtonBarSkin.CustomButtonBarFirstButtonSkin;
			}
			
			if (!lastButton)
			{
				lastButton = new ButtonBarButtonClassFactory(ButtonBarButton);
				lastButton.skinClass = skins.CustomButtonBarSkin.CustomButtonBarLastButtonSkin;
			}
			
			if (!middleButton)
			{
				middleButton = new ButtonBarButtonClassFactory(ButtonBarButton);
				middleButton.skinClass = skins.CustomButtonBarSkin.CustomButtonBarMiddleButtonSkin;
			}
